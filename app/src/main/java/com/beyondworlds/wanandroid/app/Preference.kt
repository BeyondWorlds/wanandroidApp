package com.beyondworlds.wanandroid.app
...
class Preference<T>(private val name: String, private val default: T) : ReadWriteProperty<Any?, T> {
    ...
    companion object {
        ...
        fun clear() {
            preferences.edit().clear().apply()//apply=commit   Please look up the Internet for differences
        }
    }
    ...
    private fun <U> findPreference(name: String, default: U): U = preferences.run {
